...
> = {
  events: {
    ...
    description: "Planung, Status, Künstler-Zuordnung, Checklisten und interne Notizen in einer Arbeitsliste.",
    primaryAction: "Neue Veranstaltung",
    accent: "from-teal-500 to-cyan-500",
    icon: Ticket,
    highlights: [
      { label: "Aktive Events", value: "23", tone: "text-teal-700" },
      { label: "Entwürfe", value: "6", tone: "text-slate-700" },
      { label: "Ausverkauft", value: "4", tone: "text-emerald-700" },
    ],
    workItems: [
      { title: "Status-Workflow prüfen", detail: "Entwurf -> Geplant -> Veröffentlicht", status: "Bereit" },
      { title: "Event-Checklisten", detail: "Aufgaben pro Veranstaltung mit Deadline", status: "Live" },
      { title: "Slug und öffentliche Notizen", detail: "Vorbereitet für Public Pages", status: "Nächster Sprint" },
    ],
  },
  venues: {
    title: "Spielorte",
    description: "Kapazitäten, Technik, Kontakte, Farbcodes und Auslastung für mehrere Spielorte.",
  ...
  artists: {
    title: "Künstler",
    description: "Künstlerprofile, Genres, GEMA-Nummern, Tech-Rider, Bewertungen und Favoriten.",
    primaryAction: "Künstler anlegen",
    accent: "from-rose-500 to-orange-500",
    icon: UsersRound,
    highlights: [
      { label: "Künstler", value: "148", tone: "text-rose-700" },
      { label: "Favoriten", value: "32", tone: "text-amber-700" },
      { label: "Rider offen", value: "7", tone: "text-slate-700" },
    ],
    workItems: [
      { title: "CSV-Import", detail: "Validierung und Dublettenprüfung", status: "Geplant" },
      { title: "Tech-Rider", detail: "Textfeld plus Dateiablage", status: "Vorbereitet" },
      { title: "Vertragsstatus", detail: "An Events gekoppelte Gagen und Signaturen", status: "Nächster Sprint" },
    ],
  },
  calendar: {
    title: "Multi-Venue-Kalender",
    description: "Wochen-, Monats- und Agenda-Ansicht mit farbcodierten Spielorten und Konfliktprüfung.",
    ...
    workItems: [
      { title: "Drag-and-Drop", detail: "Events verschieben mit Konfliktwarnung", status: "UI nächster Schritt" },
      { title: "Heute-Button", detail: "Schneller Rücksprung zur aktuellen Woche", status: "Live" },
      { title: "iCal Export", detail: "Öffentliche Feeds und Team-Kalender", status: "Adapter" },
    ],
  },
  newsletter: {
    title: "Newsletter",
    ...
    highlights: [
      ...
      { label: "Öffnungsrate", value: "42%", tone: "text-teal-700" },
  ...
  gema: {
    ...
    icon: FileText,
    highlights: [
      { label: "Fällig 7 Tage", value: "3", tone: "text-orange-700" },
  ...
  finance: {
    title: "Finanzen",
    description: "Budgets, Einnahmen, Ausgaben, Kassenbuch, Künstlerabrechnung und Fördermittel-Reporting.",
    ...
    workItems: [
      ...
      { title: "Abrechnung", detail: "Gagen aus Event-Künstler-Zuordnung", status: "Nächster Sprint" },
    ],
  },
  ticketing: {
    title: "Ticketing",
    description: "Tickettypen, Reservierungen, Gästeliste, QR-Code-Check-in und CSV-Import von Anbietern.",
    primaryAction: "Gästeliste öffnen",
  ...
  ai: {
    title: "KI-Assistent",
    description: "Eventtexte, Social Posts, Übersetzungen, Bildideen und Kostenkontrolle mit Provider-Wahl.",
    ...
    workItems: [
      ...
      { title: "Prompt Templates", detail: "Newsletter, Presse, Social, Programmheft", status: "Nächster Sprint" },
    ],
  },
  settings: {
    title: "Einstellungen",
    description: "Organisation, Team, Rollen, Datenschutz, Integrationen, Provider und Abrechnung.",
    primaryAction: "Provider prüfen",
    ...
    workItems: [
      ...
      { title: "Audit Trail", detail: "Änderungen zentral protokollieren", status: "Datenmodell" },
    ],
  },
};
